...
public class Board {
    ...
    private Collection<Piece> calculateActivePieces(final List<Tile> gameBoard, final Alliance alliance) {
        ...
        for(final Tile tile : gameBoard) {
            final Piece currentPiece = tile.getPiece();
            if(currentPiece.getPieceAlliance() == alliance) activePieces.add(currentPiece);
        }
    ...
    public static Board createStandardBoard() {
        ...
        builder.setPiece(new Bishop(9, Alliance.BLACK));
        builder.setPiece(new Knight(8, Alliance.BLACK));
